			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{ className: 'input-group-addon', onClick: function onClick() {
							_this2._increaseValue(_this2.state.value);
						} },
					_react2.default.createElement('i', { className: 'fa fa-plus' })
				),
				_react2.default.createElement('input', { ref: 'input', className: 'form-control', type: 'text', onChange: this._onChange, value: this.state.value }),
				_react2.default.createElement(
					'span',
					{ className: 'input-group-addon', onClick: function onClick() {
							_this2._decreaseValue(_this2.state.value);
						} },
